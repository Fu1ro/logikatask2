from PyQt5.QtWidgets import QApplication, QWidget, QHBoxLayout, QVBoxLayout, QGroupBox, QButtonGroup, QRadioButton, QPushButton, QLabel, QSpinBox, QLineEdit
...
lb_add_answer = QLabel('Введіть правильну відповидь')
...
h_create_question = QHBoxLayout()
h_create_question.addLayout(v_lb)
h_create_question.addLayout(v_qle)
...
v_main = QVBoxLayout()
v_main.addLayout(h_create_question)
